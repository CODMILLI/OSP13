...
<body>
  <div id="wrapper">
    <div class="blur">
      ...
      <script type='text/javascript' charset='UTF-8'> // month에 따라 페이지 다르게 하기 
     ...
     renderCalender();
      ...
      <div id="top5canalysis"> 
        <?php //month에 따른 content 정보들 array에 저장 
          ...
          array_push($recent5artist,$recentartist);
            ...
            print "<div class='rankingbox'><p id='ranking_num'>".(string)($i+1)."</p>
      ...
      <!-- <script type="text/javascript" charset="UTF-8"> 
       ...
       {print "<div class='tag'style='left:".strval($i*80)."px;'>#".$key."</div>"; $i+=1;
      }
